...
from ...common.interfaces.career.products import Product, ProductDto


class ProductsService[Properties: Any](RestfulService[Product[Properties], ProductDto[Properties]]):
  def __init__(self, client: httpx.Client, path_prefix: str = "/"):
    super().__init__("career/products", client=client, path_prefix=path_prefix)
